...
$company_id=$_POST['company_id'];
 ...
 echo "<script> alert('Seller approved successfully');
window.location.href='unapproved_sellers.php';
 </script>";
...
<center><button name="suspend" class="btn btn-danger">Approve </button></center>
</form>
  </div><br>
