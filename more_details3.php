...
$company_id=$_POST['company_id'];
  ...
  mysqli_query($conn,"UPDATE  company SET status=1 WHERE company_id=$company_id");
 echo "<script> alert('Seller unsuspended successfully');
window.location.href='suspended_sellers.php';
 </script>";
...
<center><button name="suspend" class="btn btn-danger">Unsuspend </button></center>
</form>
  </div><br>
